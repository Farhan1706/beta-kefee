...
<div id="page-content-wrapper">
    ...
    <section data-aos="fade" id="portfolio" class="bg-light">
        <div class="container">
            ...
            $query=mysql_query("select * from items where stok='1' LIMIT $start, $limit");
	...
	<!-- Modal START -->
	<div class="modal fade" id="keranjang" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			Berhasil Ditambahkan Menuju Keranjang Pesanan
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Lanjut Pemesanan</button>
			<button type="button" onclick="window.location.href='Daftar-Pesanan.php';" class="btn btn-primary">Lihat Daftar Pesanan</button>
		  </div>
		</div>
	  </div>
	</div>
