...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<table class="table col-md p-5 ml-4">
	 
    <tr>
    	<td style="width:14%"><label class="control-label">Nama Produk.</label>
    ...
    <tr>
        ...
        <td>
        	<div class="form-group">
				<textarea class="form-control" id="exampleFormControlTextarea1" type="text" name="item_explain" rows="3"><?php echo $item_explain; ?></textarea>
			</div>
        </td>
    </tr>
	<tr>
		<td>
			<label class="control-label">Tampilkan Barang</label>
		</td>
		<td>
		<div class="btn-group btn-group-toggle" data-toggle="buttons">
		<label class="btn btn-outline-success <?php if($stok=='1'){echo("active"); }else{ } ?>">
			<input type="radio" name="stok" id="option1" value="1" autocomplete="off" checked> Aktif
		</label>
		<label class="btn btn-outline-warning <?php if($stok=='0'){ echo("active"); }else{} ?>">
			<input type="radio" name="stok" id="option2" value="0" autocomplete="off"> Pasif
		</label>
		</div>
		</td>
	</tr>
