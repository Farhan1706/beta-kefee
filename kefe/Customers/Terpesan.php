    ...
    <footer>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="window.open('https://invoice-staging.xendit.co/web/invoices/5e682c489baa8c2741c3f6bc','_blank')" class="btn btn-primary col">Bayar Online</button>
            </div>
            </div>
        </div>
        </div>
