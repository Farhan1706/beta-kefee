...
<body id="page-top">
                ...
                <div class="col-lg-12">
                    <ul class="list-group timeline">
                        <li class="list-group-item">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="../assets/img/about/1.jpg" data-bs-hover-animate="pulse"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>September 2019</h4>
                                    <h4 class="subheading" style="color: rgb(254,214,5);">Ide Project</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">Ditemukannya Ide Pembuatan Proyek Ini</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item timeline-inverted">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="../assets/img/about/2.jpg" data-bs-hover-animate="pulse"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>Desember 2019</h4>
                                    <h4 class="subheading" style="color: rgb(255,214,2);">Mencari Sumber</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">Mencari segala sumber daya sebagai pendukung terealisasinya ide proyek ini</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>Januari 2020</h4>
                                    <h4 class="subheading" style="color: rgb(254,214,5);">Langkah Perealisasian</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">Kami Memulai Untuk Merealisasikan Terbentuknya Proyek Ini</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item timeline-inverted" data-bs-hover-animate="flash">
                            <div class="timeline-image" style="width: 193px;height: 196px;">
                                <h4 style="font-size: 22px;height: 100px;">Jadilah<br>Bagian dari Cerita Kami<br>Selanjutnya</h4>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <section class="py-5" style="background-color: #dcd7d7;">
        <div class="container">
            <div class="row">
    ...
    <section data-aos="fade" id="contact" style="background-image:url('../assets/img/map-image.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
